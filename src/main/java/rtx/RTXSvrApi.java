...
public class RTXSvrApi {
	...
	public native int AddProperty(int iPropertyHandle, String szName,
			String szValue);
	...
	public int QueryUserState(String UserName) {
		...
		// AddProperty(iProp,KEY_UINTYPE,"Account"); 如果设置KEY_UINTYPE
		// 为Account，无论传进去是纯数字还是字符串，都认为是帐号。
		...
		if (innerCode != 0) {
			System.out.println("错误代码:" + innerCode + "\t" + "错误信息："
					+ GetResultErrString(iResult));
			release();
			return innerCode;
		}
	 ...
	 * @return int 0 操作成功 非0为失败
	 */
	public int SetUserSimpleInfo(String UserName, String ChsName, String email,
			String gender, String mobile, String phone, String pwd) {
		...
		if (innerCode != 0) {
			...
			for (int i = 0; i < iCount; i++) {
				if (i == 9) {
					...
					int iHandle = GetPropertysItem(iProps, i);
					AddProperty(iProp, GetPropertyItemName(iHandle),
	 ...
	 * @return int 0 操作成功 非0为失败
	 */
	public int SetUserSimpleInfoEx(String UserName, String DeptID,
			String ChsName, String email, String gender, String mobile,
	 ...
	 * @return int 0 操作成功 非0为失败
	 */
	public int setUserDetailInfo(String UserName, String ADDRESS, String AGE,
			String BIRTHDAY, String BLOODTYPE, String CITY, String COLLAGE,
			String CONSTELLATION, String COUNTRY, String FAX, String HOMEPAGE,
			String MEMO, String POSITION, String POSTCODE, String PROVINCE,
			String STREET, String PHONE, String MOBILE) {
		...
		if (BLOODTYPE != null && !"".equals(BLOODTYPE)
				&& !"null".equals(BLOODTYPE)) {
	 ...
	 * @return int 0 操作成功 非0为失败
	 */
	public int setDept(String deptId, String DetpInfo, String DeptName,
			String ParentDeptId) {
	 ...
	 */
	public int sendSms(String sender, String receiver, String smsInfo,
	...
	public String GetDeptName(String deptID) {
		...
		if (innerCode != 0) {
			...
			int iProps = GetResultPropertys(iResult);
			int iCount = GetPropertysCount(iProps);
			System.out.println("GetResultPropertys:" + iProps + "\t"
					+ "GetPropertysCount:" + iCount);
