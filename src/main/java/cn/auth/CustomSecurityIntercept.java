...
public class CustomSecurityIntercept extends FilterSecurityInterceptor {
	...
	private boolean loginProtectUrl(ServletRequest request) {
		return false;
	}

	private boolean publicUrl(ServletRequest request) {
		return false;
	}
